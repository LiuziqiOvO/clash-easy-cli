...
# 项目结构与说明（2025-07-17 更新）

本项目已彻底移除 shell 旧版相关内容，仅保留 Python 重构版及其依赖、配置、工具和文档。

## 当前目录结构简述
- clash_cli/         # Python 主程序及核心模块
- pyproject.toml     # Python 依赖与项目配置
- requirements.txt   # 依赖列表
- README.md          # 用户文档
- README4ai.md       # AI 记忆与维护文档
- conf/、logs/、temp/ # 配置、日志与临时文件
- tools/             # 订阅转换等辅助工具
- dashboard/         # Web 控制面板资源



仅保留 Python 版本，后续维护与开发请以 Python 代码为主。

# 项目目录结构（tree 格式，2025-07-17）
